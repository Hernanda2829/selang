...
<head>
    ...
    ?>
    <title>Cetak Kirim Stok <?php echo $userid['reg_name'];?></title>
...
<table border="0" align="center" style="width:700px; border:none;margin-top:5px;margin-bottom:0px;">
    <tr>
        ...
        <td style="width:700px; padding-left:0px;">
            <center>
                <h4 style="margin: 0; margin-left: -110px;">TRANSFER STOK <?php echo strtoupper($userid['reg_code']);?>  <?php echo strtoupper($userid['reg_name']);?></h4>
                <h4 style="margin: 0; margin-left: -110px;">TANGGAL KIRIM : <?php echo strtoupper($ks['trans_stok_tgl']);?></h4>
                <h4 style="margin: 0; margin-left: -110px;">CABANG PENERIMA : <?php echo strtoupper($ks['reg_name']);?></h4>
