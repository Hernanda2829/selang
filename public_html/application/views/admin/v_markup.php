   ...
   ?>
    ...
    <div class="container">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab1" style="font-size:12px;"><b>Buat Markup</b></a></li>
            <li><a data-toggle="tab" href="#tab2" style="font-size:12px;"><b>Data Markup</b></a></li>
        ...
        <div class="tab-content">
                ...
                <div class="row">
                    ...
                    <thead>    
                        <tr>
                            ...
                            <td style="width:5%;vertical-align:middle;padding-right:10px;">
                                <a href="#modalHapus" data-toggle="modal" class="btn btn-sm btn-danger" title="Hapus Data Markup"><span class="fa fa-trash"></span> Hapus Data</a>
                            </td>
                            <td style="width:3%;vertical-align:middle;padding-right:5px;">
                                <button class="btn btn-sm btn-info" title="Cetak Faktur Data Markup untuk Customer/Pelanggan" onclick="varCetak_Markup()"><span class="fa fa-print"></span> </button>
                            </td>
                            <td style="width:3%;vertical-align:middle;">
                                <button class="btn btn-sm btn-success" title="Cetak Faktur Data Markup untuk Internal" onclick="varCetak_Markup2()"><span class="fa fa-print"></span> </button>
                            </td>
            ...
            <div id="tab2" class="tab-pane fade">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="myMarkup" class="form-horizontal" method="post" action="" target="_blank">
                ...
                <div class="row">
                    <div class="col-lg-12">        
                        <table id="tbl_data_markup" class="table table-bordered table-condensed" style="font-size:11px;">
                            <thead>
                                <tr>
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Data Penjualan</small></h3>
            </div>
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 class="modal-title" id="myModalLabel"><small>Edit Data</small></h3>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h3 class="modal-title" id="myModalLabel">Hapus Data Markup</h3>
                </div>
                    <div class="modal-body">
                        <p>Yakin mau menghapus data markup ?</p>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-primary btn-hapus" data-dismiss="modal">Hapus</button>
                        <button class="btn" data-dismiss="modal" aria-hidden="true">Tutup</button>
                    </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tbl_data_markup').DataTable();  
    });
</script> 

<script>
    function varCetak_Data() {
        var form = document.querySelector('#myMarkup'); 
        form.action = "<?php echo base_url().'admin/markup/cetak_data_markup';?>";
        form.target = '_blank';
...
$(document).ready(function () {
    $(document).on('click', '.btn-tampil', function () {
        $('#tbl_data_markup tbody').empty();
        var tgl1 = $('#tgl1').val();
        var tgl2 = $('#tgl2').val();

        $.ajax({
            url: "<?php echo base_url().'admin/markup/get_data_markup';?>",
            type: "POST",
            data: {
                tgl1: tgl1,
                tgl2: tgl2
            ...
            success: function (data) {
                ...
                if (parsedData.length !== 0) {
                        ...
                        $.each(parsedData.data, function (index, item) {
                                no++;
                                var tot = parseFloat(item.jual_total);
                                var newRow = '<tr>' +
                                    ...
                                    '<td style="font-size:11px;text-align:center;">' + item.jual_tanggal + '</td>' +
                                    ...
                                    '<td style="font-size:11px;text-align:right;">' + tot.toLocaleString('id-ID') + '</td>' +
                                    '</tr>';
                                $('#tbl_data_markup tbody').append(newRow);
...
$(document).ready(function () {
    ...
    function handleNofakChange() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url().'admin/markup/get_detail_jual';?>",
            data: { nofak: nofak },
            dataType: 'json',
            success: function (data) {
    ...
    $(document).on('click', '.btn-hapus', function () {
        var nofakH = $("#nofak").val();
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/markup/hapus_markup');?>",
            data: {
                nofak: nofakH
            },
            dataType: 'json',
...
$(document).ready(function () {
    $(document).on('click', '.btn-buatmarkup', function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url().'admin/markup/create_jual';?>",
            data: { nofak: nofak },
            dataType: 'json',
            success: function (data) {
...
<script type="text/javascript">
    ...
    function tampilMarkup() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url().'admin/markup/get_markup';?>",
            data: { nofak: nofak },
            dataType: 'json',
            success: function (data) {
                //console.log("Received data:", data);
...
<script type="text/javascript">   
    $(document).ready(function () {
        ...
        $(document).on('click', '.savebyr', function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url().'admin/markup/save_bayar';?>",
                data: {
                    nofak  : nofakM,
                    jmlbyr : jmlbyrM,
                    totjual : totjualM 
...
<script type="text/javascript">
    $(document).on('click', '.btn-update', function () {
        ...
        if (!harjulV.trim()) { 
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url().'admin/markup/update_markup';?>",
                data: {
                    nofak  : nofakV,
                    idbrg  : idbrgV,
                    harjul : harjulV,
...
<script>
    function varCetak_Markup() {
        ...
        var pathC = "<?php echo base_url().'admin/markup/cetak_faktur/';?>";
    ...
    function varCetak_Markup2() {
        var nofakC = $("#nofak").val();
        var pathC = "<?php echo base_url().'admin/markup/cetak_faktur2/';?>";
        var form = document.querySelector('#myForm'); 
        form.action = pathC + nofakC;
        form.target = '_blank';
        form.submit(); // Mengirimkan formulir
