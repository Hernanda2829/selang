...
<body>
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 style="margin: 0;">Data Penjualan <small><?php echo $userid['reg_code'];?>  <?php echo $userid['reg_name'];?></small></h3>
            </div>
        </div>
        <hr/>
                ...
                <table style="font-size:12px;margin-bottom:10px;">
                    ...
                    <tr>
                        ...
                        <td style="width:5%;vertical-align:middle;">
                            <button class="btn btn-sm btn-info" title="Cetak Data" onclick="varCetak_Penjualan()"><span class="fa fa-print"></span> Cetak Data</button>
                        </td>
                    </tr>
                </table>
                </form>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                ...
                                <a class="btn btn-xs btn-info" href="<?php echo base_url() . 'admin/penjualan_data/cetak_faktur/' . $nofak; ?>" target="_blank" title="Cetak Faktur untuk Customer/Pelanggan"><span class="fa fa-print"></span> Faktur</a>
                                <a class="btn btn-xs btn-success" href="<?php echo base_url() . 'admin/penjualan_data/cetak_faktur2/' . $nofak; ?>" target="_blank" title="Cetak Faktur untuk Internal"><span class="fa fa-print"></span> Faktur</a>
                            </td>
                        </tr>
                    <?php endforeach;?>
                ...
                <div class="tab-content">
                    ...
                    <div id="tabJual" class="tab-pane fade in active">
                        ...
                        <p style="font-size: 11px; margin-bottom: 0;">
                            ...
                            <span style="float: right;">Jenis Pembayaran : <b><span id="jenValue2" style="color: green;"></b></span>
                        </p>
                        <p style="font-size: 11px; margin-bottom: 0;">
                ...
                if (parsedData.length !== 0) {
                        ...
                        $.each(parsedData.data, function (index, item) {
                                ...
                                var newRow = '<tr>' +
                                    ...
                                    '<a class="btn btn-xs btn-info btn-lihatjual" href="#modalLihatJual" data-toggle="modal" data-nofak="' + item.jual_nofak + '" data-nmcust="' + item.jual_cust_nama + '" data-tmpbln="' + item.jual_bulan_tempo + '" data-tmptgl="' + item.jual_tgl_tempo + '" data-jenisbyr="' + item.jual_bayar + '" title="Lihat Data Penjualan"><span class="fa fa-eye"></span> Lihat</a> ' +
                                    '<a class="btn btn-xs btn-info" href="<?php echo base_url() . 'admin/penjualan_data/cetak_faktur/' ?>' + item.jual_nofak + '" target="_blank" title="Cetak Faktur untuk Customer/Pelanggan"><span class="fa fa-print"></span> Faktur</a> ' +
                                    '<a class="btn btn-xs btn-success" href="<?php echo base_url() . 'admin/penjualan_data/cetak_faktur2/' ?>' + item.jual_nofak + '" target="_blank" title="Cetak Faktur untuk Internal"><span class="fa fa-print"></span> Faktur</a>' +
                                    '</td>' +
                                    '</tr>';
