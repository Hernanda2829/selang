    ...
    <div class="container">
            ...
            <div class="col-lg-9">
                ...
                <table class="table table-bordered" style="font-size:12px;margin-bottom:10px;">
                    ...
                    <tr>
                        ...
                        <td style="width:10%;vertical-align:middle;text-align:right;border-top-color:white;border-right-color:white;">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center" style="margin-bottom:20px;">
                <span style="color:#e26b0a;font-size:14px;"><b>LAPORAN KEUANGAN DAN PENJUALAN  <?php echo strtoupper($namacab);?></b></span>
                <br>
...
$(document).ready(function () {
    $('select[name="regid"]').on('change', function() {
        //const cabang = $('#cab option:selected').val();
    ...
    $(document).on('click', '.btn-tampil', function () {
        ...
        form.action = "<?php echo base_url().'admin/keuangan/get_bulan_lap_admin';?>"; 
        form.target = '_self';
