            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center">Kategori Report</th>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/kategori/tambah_kategori'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="kategori" class="form-control" type="text" placeholder="Input Nama Kategori..." style="width:280px;" maxlength="35" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kategori Report</label>
                        <div class="col-xs-9">
                            <input name="katreport" class="form-control" type="text" placeholder="Nama Kategori Report" style="width:280px;" maxlength="35" required>
                        </div>
                    </div>
                </div>
        ...
        <?php
                ...
                <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Kategori</label>
                        <div class="col-xs-9">
                            <input name="kategori" class="form-control" type="text" value="<?php echo $nm;?>" style="width:280px;" maxlength="35" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kategori Report</label>
                        <div class="col-xs-9">
                            <input name="katreport" class="form-control" type="text" value="<?php echo $rp;?>" style="width:280px;" maxlength="35" required>
                        </div>
                    </div>
