...
?>
    <tr>
        ...
        <td style="width:13%;text-align:right; padding-left:5px; padding-right:3px;"><span style="float:left;">Rp</span><?php echo number_format($harjul, 0, ',', '.');?></td>
        ...
        <td style="width:13%;text-align:right; padding-left:5px; padding-right:3px;"><span style="float:left;">Rp</span><?php echo number_format($total, 0, ',', '.');?></td>
    </tr>
<?php }?>
</tbody>
<tfoot>
    <tr>
        <td colspan="6" style="padding-left:5px;font-weight:normal;"><b>Terbilang</b> :<i> <?php echo terbilang(ceil($b['jual_total']));?> rupiah</i></td>
