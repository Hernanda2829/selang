...
<tr>    
    ...
    <td colspan="2" style="width:900px;padding-left:0px;"><center><h4 style="margin-left: -110px;">LAPORAN DATA BARANG <?php echo strtoupper($reg_id['reg_code']);?>  <?php echo strtoupper($reg_id['reg_name']);?></h4></center><br/></td>
</tr>                   
</table>
...
$nomor=1;
    ...
    $group=$d['kategori_nama'];
        ...
        <tr>
                ...
                <td style="text-align:center;vertical-align:center;padding-left:5px;"><?php echo $d['barang_id']; ?></td>
