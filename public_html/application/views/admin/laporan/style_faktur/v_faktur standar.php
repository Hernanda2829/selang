...
?>
    <tr>
        ...
        <td style="text-align:right;padding-right:3px;"><?php echo 'Rp '.number_format($harjul);?></td>
        <td style="text-align:center;"><?php echo $qty;?></td>
        <td style="text-align:right;padding-right:3px;"><?php echo 'Rp '.number_format($diskon);?></td>
        <td style="text-align:right;padding-right:3px;"><?php echo 'Rp '.number_format($total);?></td>
    </tr>
<?php }?>
</tbody>
<tfoot>
