...
<head>
    ...
    ?>
    <title>Laporan Data Penjualan <?php echo $reg_id['reg_name'];?></title>
...
<tr>
    ...
    <td colspan="2" style="width:800px;paddin-left:0px;"><center><h4 style="margin-left: -110px;">LAPORAN PENJUALAN BARANG <?php echo strtoupper($reg_id['reg_code']);?> <?php echo strtoupper($reg_id['reg_name']);?></h4></center><br/></td>
</tr>                   
</table>
