...
<head>
    ...
    ?>
    <title>Lap Penjualan <?php echo $ket." ".$reg_id['reg_name'];?></title>
...
<tr>
    ...
    <td colspan="2" style="width:800px;paddin-left:0px;"><center><h4 style="margin-left: -110px;">LAPORAN PENJUALAN <?php echo strtoupper($ket) ." " .strtoupper($reg_id['reg_code']);?> <?php echo strtoupper($reg_id['reg_name']);?></h4></center><br/></td>
</tr>                   
</table>
