...
<head>
    ...
    ?>
    <title>Laporan Keuangan <?php echo $userid['reg_name'];?></title>
...
<table border="0" align="center" style="width:650px; border:none;margin-top:5px;margin-bottom:0px;">
    <tr>
        ...
        <td style="width:750px; padding-left:0px;">
            <center>
                <h4 style="margin: 0; margin-left: -110px;">LAPORAN KEUANGAN <?php echo strtoupper($userid['reg_code']);?> <?php echo strtoupper($userid['reg_name']);?></h4>
...
<div class="row">
    <div class="col-lg-8">
        <table border="1" align="center" style="width:650px;margin-bottom:20px;">
            ...
            echo '<td style="width:10%;text-align:right;"></td>';
            echo '<td style="width:2%;vertical-align:middle;text-align:center;border-right-color:white;">Rp </td>';
            echo '<td style="width:10%;vertical-align:middle;text-align:right;border-top: 2px solid black;padding-right:3px;"><span style="color:#538dd5;"><b>'. str_replace(',', '.', number_format($jmlV)) . '</span></b></td>';
            echo '</th>';
            echo '</tr>';
