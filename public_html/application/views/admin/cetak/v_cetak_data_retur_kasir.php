...
<table border="0" align="center" style="width:700px; border:none;margin-top:5px;margin-bottom:0px;">
    <tr>
        ...
        <td style="width:700px; padding-left:0px;">
            <center>
                <h4 style="margin: 0; margin-left: -110px;">LAPORAN DATA RETUR BARANG - <?php echo strtoupper($userid['reg_code']);?> <?php echo strtoupper($userid['reg_name']);?> </h4>
    ...
    <div class="col-lg-12">        
        ...
        <tbody>             
            ...
            <tr>
                ...
                <td style="text-align:right;padding-right:3px;"><?php echo number_format($d['retur_harjul'],0, ',' ,'.'); ?></td>
                <?php 
                $qty=$d['retur_qty'];
                if (floor($qty) == $qty) {
            ...
            <tr>
                ...
                <td style="text-align:right;padding-right:3px;"><b><?php echo number_format($totalHargaJual, 0, ',', '.'); ?></b></td>
                <td></td>
