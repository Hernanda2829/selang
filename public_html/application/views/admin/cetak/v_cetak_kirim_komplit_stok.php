...
<head>
    ...
    ?>
    <title>Cetak Kirim Komplit Stok <?php echo $userid['reg_name'];?></title>
...
<table border="0" align="center" style="width:700px; border:none;margin-top:5px;margin-bottom:0px;">
    <tr>
        ...
        <td style="width:700px; padding-left:0px;">
            <center>
                <h4 style="margin: 0; margin-left: -110px;">TRANSFER STOK</h4>
                <h4 style="margin: 0; margin-left: -110px;">CABANG PENGIRIM : <?php echo strtoupper($ks['cabang_pengirim']);?></h4>
                <h4 style="margin: 0; margin-left: -110px;">TANGGAL KIRIM : <?php echo strtoupper($ks['trans_stok_tgl']);?></h4>
                <h4 style="margin: 0; margin-left: -110px;">CABANG PENERIMA : <?php echo strtoupper($ks['cabang_penerima']);?></h4>
                <h4 style="margin: 0; margin-left: -110px;">TANGGAL KONFIRM : <?php echo strtoupper($ks['tgl_konfirm']);?></h4>
            </center>
        </td>
    </tr>
</table>
...
<table border="1" align="center" style="width:700px; border:none;margin-top:5px;margin-bottom:0px;">
    ...
    <tbody>
        ...
        foreach ($detail_transtok as $t):
            ...
            $qty=$t['kirim_qty'];
            $kon_qty=$t['konfirm_qty'];
            $sel_qty=$t['selisih_qty'];
    ...
    <tr>
        ...
        <td style="text-align:center;"><?php echo $kon_qty?></td>
        <td style="text-align:center;">
            <span style="color:<?php echo ($sel_qty > 0) ? 'red' : 'black'; ?>;">
                <?php echo $sel_qty; ?>
            </span>
        </td>
        <td><?php echo $kd;?></td>
