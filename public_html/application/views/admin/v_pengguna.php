...
<head>
    ...
    $lv_user=$userid['user_level_nama'];
    ?>  
    <meta charset="utf-8">
   ...
   ?>
    ...
    <div class="container">
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-xs btn-info" href="#modalEditPengguna<?php echo $id?>" data-toggle="modal" title="Edit"><span class="fa fa-edit"></span> Edit</a>
                            <?php if(!empty($status) && ($status==1)){
                                echo '<a class="btn btn-xs btn-warning" href="#modalNonAktifkan'.$id.'" data-toggle="modal" title="Nonaktifkan"><span class="fa fa-close"></span> Nonaktifkan</a>';
                            }else{
                                echo '<a class="btn btn-xs btn-warning" href="#modalAktifkan'.$id.'" data-toggle="modal" title="Nonaktifkan"><span class="fa fa-close"></span> AktifkanLagi </a>';
                            }
                            ?>
                            <?php
                            if ($lv_user == "Super Admin") {
                                echo '<a class="btn btn-xs btn-danger" href="#modalHapus'.$id.'" data-toggle="modal" title="Hapus Pengguna"><span class="fa fa-trash-o"></span> Hapus</a>';
                            }
                            ?>
                        </td>
                    </tr>
        ...
        <div id="modalHapus<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="modal-title" id="myModalLabel"><small>Hapus Pengguna</small></h3>
            </div>
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/pengguna/hapus_pengguna'?>">
                <div class="modal-body">
                    <p>Yakin mau menghapus Data Pengguna : <br>
                    User : <b><span><?=$a['user_nama'];?></span></b><br>
                    User Title : <b><span><?=$a['user_title'];?></span></b><br>
                   <input name="kode" type="hidden" value="<?php echo $id; ?>">
