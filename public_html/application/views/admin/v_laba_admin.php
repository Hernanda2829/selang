    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 mx-auto text-center" style="margin-bottom:20px;">
                <span style="color:#e26b0a;font-size:14px;"><b>LAPORAN LABA PENJUALAN <?php echo strtoupper($namacab);?></b></span>
                <br>
                <span id="periode" style="color:#e26b0a;font-size:14px;"><b>BULAN <?= strtoupper($nm_bln).' ' .$thn;?> </b></span>
            </div>
            <div class="col-lg-12">
                ...
                <?php
                $profit=0;
                $pengeluaran=$beban['pengeluaran'];
                $profit=$totlaba - $pengeluaran;
                ?>
                <table style="font-size: 11px; margin-bottom: 5px;">
                    <tr>
                        <th style="width: 150px; vertical-align: middle;">Laba Bersih Tunai</th>
                        <td style="width: 10px; vertical-align: middle;">Rp.</td>
                        <td style="width: 100px; vertical-align: middle; text-align: right;"><?= str_replace(',', '.', number_format($totlaba_tunai)); ?></td>
                    </tr>
                    <tr>
                        <th style="width: 150px; vertical-align: middle;">Laba Bersih Piutang</th>
                        <td style="width: 10px; vertical-align: middle;">Rp.</td>
                        <td style="width: 50px; vertical-align: middle; text-align: right;"><?= str_replace(',', '.', number_format($totlaba_piutang)); ?></td>
                    </tr>
                    <tr>
                        <th style="width: 150px; vertical-align: middle;">Total Laba</th>
                        <td style="width: 10px; vertical-align: middle;">Rp.</td>
                        <td style="width: 50px; vertical-align: middle; text-align: right; border-top: 2px solid black;"><?= str_replace(',', '.', number_format($totlaba)); ?></td>
                    </tr>
                    <tr>
                        <th style="width: 150px; vertical-align: middle;">Pengeluaran</th>
                        <td style="width: 10px; vertical-align: middle;">Rp.</td>
                        <td style="width: 50px; vertical-align: middle; text-align: right;color:#ff0000;"><?= str_replace(',', '.', number_format($pengeluaran)); ?></td>
                    </tr>
                    <tr>
                        <th style="width: 150px; vertical-align: middle;">Laba</th>
                        <td style="width: 10px; vertical-align: middle;">Rp.</td>
                        <td style="width: 50px; vertical-align: middle; text-align: right; border-top: 2px solid black;"><?= str_replace(',', '.', number_format($profit)); ?></td>
                    </tr>
                </table>
